...
./$TOOLSDIR/osmfilter -v workfiles/england-latest.o5m --keep="boundary=administrative place=" --keep-ways-relations="boundary=administrative" --drop="highway= waterway= route=" --out-osm -o=workfiles/england-latest.osm
./$TOOLSDIR/osmfilter -v workfiles/scotland-latest.o5m --keep="boundary=administrative place=" --keep-ways-relations="boundary=administrative" --drop="highway= waterway= route=" --out-osm -o=workfiles/scotland-latest.osm
./$TOOLSDIR/osmfilter -v workfiles/wales-latest.o5m --keep="boundary=administrative place=" --keep-ways-relations="boundary=administrative" --drop="highway= waterway= route=" --out-osm -o=workfiles/wales-latest.osm
# ./$TOOLSDIR/osmfilter -v workfiles/great-britain-latest.o5m --keep="boundary=administrative place=" --keep-ways-relations="boundary=administrative" --keep-ways= --keep-nodes= --keep-relations= --out-osm -o=workfiles/great-britain-latest.osm
./$TOOLSDIR/osmfilter -v workfiles/northern-ireland-latest.o5m --keep="boundary=administrative place=" --keep-ways-relations="boundary=administrative" --drop="highway= waterway= route=" --out-osm -o=workfiles/northern-ireland-latest.osm
# ./$TOOLSDIR/osmfilter -v workfiles/United-Kingdom.o5m --keep="boundary=administrative place=" --keep-ways-relations="boundary=administrative" --keep-ways= --keep-nodes= --keep-relations= --out-osm -o=workfiles/United-Kingdom.osm
