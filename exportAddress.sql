...
-- We want to create a real address file. we do this by faking the postcode into a housenumber.
-- As we need to merge it with real osm files we will make our node id negative, as that's 
-- the standard to describe that your entries are not yet in OSM (yet).
-- England
